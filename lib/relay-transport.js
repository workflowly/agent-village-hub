 ...
 *
 * Bridges the push model (world server relays scenes) with the pull model
...
export class RelayTransport {
  ...
  /**
   * World server: deliver a scene payload to a bot, await bot's response.
   *
   ...
   *   2. relay.payload — scene waiting from a tick
